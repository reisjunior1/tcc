            ...
            <div class="col-4 m-auto">
                ...
                >
                    ...
                    <select id="slFormato" name="slFormato" class="form-select">
                        ...
                        <option
                            value="PC" {{isset($formato) ? ($formato == 'PC' ? 'selected' : '') : ''}}>Pontos Corridos
                        </option>
                    ...
                    <select name="slTime"  id="slTime" class="form-select">
                        ...
                        @foreach($times as $time)
                            <option value= {{$time['id']}} {{isset($slTime) ? ($slTime == $time['id'] ? 'selected' : '') : ''}}>
                                {{$time['nome']}}
                            </option>
                        @endforeach
                    </select>
                    ...
                    @foreach($campeonatos as $campeonato)
                        <tr>
                            ...
                            <td>
                                ...
                                <form
                                    id="submit-form"
                                    action={{route("campeonato.criarPartida", ['idCampeonato'])}}
                                    method='PUT'
                                    class="hidden"
                                >
                                    @csrf
