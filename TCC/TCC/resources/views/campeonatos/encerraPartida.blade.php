...
@endif
  ...
  <div class="mx-auto" style="width: 800px;">
    <div class="col-md-6 campo">
        ...
        <input type="text" class="form-control minutos" name="inTempo{{$i}}" id="inTempo{{$i}}" value="{{isset($dados['inHora']) ? $dados['inHora'] : null}}" placeholder="Hora de início">
            

    </div>
    <div class="col-md-1">
      <label for="code" class="text-left"></label><br>
      <button type="button" class="btn btn-success add-campo" id="add-campo">
        +
      </button>
    </div>
    <br>
