...
@endif
  ...
  <div class="mx-auto" style="width: 800px;">
    <div class="col-md-6">
        ...
        <input type="password" class="form-control" id="inSenhaAtual" name='inSenhaAtual' placeholder="Senha Atual">

        <label for="inNovaSenha" class="form-label">Digite uma nova senha:</label>
        <input type="password" class="form-control" id="inNovaSenha" name='inNovaSenha' placeholder="Nova Senha">

        <label for="inConfirmaSenha" class="form-label">Confirme a nova senha:</label>
        <input type="password" class="form-control" id="inConfirmaSenha" name='inConfirmaSenha' placeholder="Confirme a Senha">
